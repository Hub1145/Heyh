...
SYMBOL = 'BTC'
POSITION_SIZE_PCT = 1.0  # 100% of current equity
...
class RobinhoodBot:
    ...
    def login(self):
        if ROBINHOOD_USER == "your_email@example.com":
            print("Please update ROBINHOOD_USER and ROBINHOOD_PASS in the bot.py script.")
            return False
        try:
            ...
            try:
                ...
                if self.position is None:
                    ...
                    if now.hour < 12:
                        ...
                        # Long Entry: Price crosses Daily Open and MACD Histogram slope is up
